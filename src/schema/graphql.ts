...
export abstract class IMutation {
  ...
  abstract createExamQuestion(
    examId: number,
    item: string,
    indexNum: number,
    answer: string,
    fileUrl: Nullable<string>[],
  ): CommonResponse | Promise<CommonResponse>;

  abstract editExamQuestion(
    id: number,
    examId?: Nullable<number>,
    item?: Nullable<string>,
    indexNum?: Nullable<number>,
    answer?: Nullable<string>,
    fileUrl?: Nullable<Nullable<string>[]>,
  ): CommonResponse | Promise<CommonResponse>;
...
export abstract class IQuery {
  ...
  ): Nullable<CommentDataResult> | Promise<Nullable<CommentDataResult>>;
